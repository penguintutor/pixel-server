...
RUN apk add build-base linux-headers libffi-dev --no-cache && \
    pip install --upgrade --no-cache-dir argon2_cffi Flask-WTF rpi_ws281x flask adafruit-blinka RPi.GPIO adafruit-python-shell setuptools adafruit-circuitpython-neopixel && \
